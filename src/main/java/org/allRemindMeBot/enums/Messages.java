...
public enum Messages {
    ...
    ERROR_MSG(Emoji.ERROR_EMOJI.getEmojiStr() + " Прочтите справочную информацию " + Emoji.ERROR_EMOJI.getEmojiStr()),
    INFO_MSG(Emoji.HART_EMOJI.getEmojiStr() + " Уважаемый пользователь! " + Emoji.HART_EMOJI.getEmojiStr() + "\n\n" +
            "Напоминания вводится в текстовом формате с указанием даты и времени в будущем или только времени на сегодня, все Emoji очищаются:\n" +
    ...
    INFO_ALL_MSG(Emoji.REF_INFO_EMOJI.getEmojiStr() + " Уважаемый пользователь! " + Emoji.REF_INFO_EMOJI.getEmojiStr() + "\n\n" +
            ...
            Emoji.INFO_EMOJI.getEmojiStr() + "Важно! Для получения напоминаний не удаляйте чат с ботом.\n");
